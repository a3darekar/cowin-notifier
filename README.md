...
## IFTTT supported Notifier for [COWIN](https://www.cowin.gov.in/home) vaccination slot availability

This service alerts your phone via IFTTT app when there is a vaccine slot available at specified location. It makes use of [Co-vin API's](https://cdn-api.co-vin.in/) public endpoints to notify user if any vaccination slots are available in your district/area PIN code.

### Initialization

1. Install [Node](https://nodejs.org/en/download/) if you already haven't.

2. Configure the `.env.example` file to include your district code or your area PIN code, your age category and your IFTTT webhook name and identifier key. Read instructions further below.

3. Rename the `.env.example` file to `.env`.

3. Run following command to install all the dependancies.
```
npm i 
```
4. Run following command to start the service 
```
npm run notifier
```
...
Integrating with [IFTTT](https://ifttt.com/) you can receive availability alerts over your mobile.

#### Setting up IFTTT 

Follow the steps mentioned in first part of this [tutorial](https://medium.com/measuring-the-great-indoors/linking-ifttt-processing-with-webhooks-6b20c6ed722d). Note down Event Name in step 5, and unique key from url in step 10. Place these values for notifier and key fields in `.env` file as mentioned in Initialization Step 3.


### <a name="District Codes">District Codes</a>
